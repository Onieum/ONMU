...
public class CharacterController {
  ...
  public ResponseEntity<CharacterProfileResponse> getMyCharacter() {
    CharacterProfileResponse response = characterService.getMyCharacter();
  ...
  public ResponseEntity<CharacterProfileResponse> saveMyCharacter(
    ...
    CharacterProfileResponse response = characterService.saveMyCharacter(request);
    return ResponseEntity.ok(response);
  }
  ...
  public ResponseEntity<CharacterProfileResponse> generateCharacter(
    ...
    CharacterProfileResponse response = characterService.generateCharacter(request);
    return ResponseEntity.ok(response);
  }
  ...
  public ResponseEntity<CharacterProfileResponse> updateSkipStatus(
    ...
    CharacterProfileResponse response = characterService.updateSkipStatus(request);
    return ResponseEntity.ok(response);
  }
}
