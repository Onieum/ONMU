...
void main() {
  testWidgets('OOTD record saves today-only style overrides and analysis fields', (tester) async {
    ...
    await tester.enterText(find.byKey(const ValueKey('pointField')), '가방으로 포인트 주기');
    await tester.enterText(find.byKey(const ValueKey('nextSuggestionField')), '다음엔 청바지랑 입어보기');
