...
class OnMoimVoteDetailPage extends StatelessWidget {
  const OnMoimVoteDetailPage({
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  OnmuChip(
                    label: demoOnMoimVoteCard.statusLabel,
                    selected: true,
                  ),
                  const Spacer(),
                  Text(
