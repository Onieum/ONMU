  ...
  Widget _buildMoodWeatherPage() {
    return Column(
      ...
      children: [
        ...
        const Text('오늘 기분', style: _labelStyle),
        const SizedBox(height: 8),
        _choiceGrid(
          _moods,
          _selectedMood,
        ...
        const Text('날씨', style: _labelStyle),
        const SizedBox(height: 8),
        _choiceGrid(
          _weathers,
          _selectedWeather,
        ...
        const SizedBox(height: 20),
        const Text('하루 해시태그', style: _labelStyle),
        const SizedBox(height: 8),
        Row(
          children: [
            Expanded(
...
class _DiaryPhotoSpread extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: photoFirst
          ? [photo, const SizedBox(width: 12), memo]
          : [memo, const SizedBox(width: 12), photo],
    );
  }
}
