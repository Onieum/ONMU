...
const mockMembers = [
  ...
  MeetupMember(name: '지영', message: '카페 투어 좋아해요', badge: '선택됨', selected: true),
  MeetupMember(
    name: '민수',
    message: '이번엔 내가 추천할게!',
    badge: '시간 제안',
  ...
  MeetupMember(name: '하린', message: '좋아요 좋아요', badge: '선택됨', selected: true),
  MeetupMember(
    name: '서준',
    message: '이번엔 시간이 될지...',
    badge: '초대',
...
const mockMeetup = Meetup(
  ...
  members: mockMembers,
  timeCandidates: mockTimeCandidates,
  visitPlan: [
    VisitPlan(
      time: '13:00',
      endTime: '14:30',
